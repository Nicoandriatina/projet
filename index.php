          ...
          <div class="modal-body">
            ...
            <form action="" method="post" id="formOrder">
              <div class="form-floating mb-3">
                ...
                <label for="customer">Nom du Bateau</label>
              </div>
              <div class="form-floating mb-3">
                <input type="text" class="form-control" id="cashier" name="cashier">
                <label for="cashier">Marque et categories</label>
              </div>
              ...
              <div class="row g-2">
                <div class="col-md">
                  <div class="form-floating mb-3">
                    ...
                    <label for="amount">charge Maximal</label>
                  </div>
                </div>
                <div class="col-md">
                  <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="receive" name="received">
                    <label for="receive">charge Minimal</label>
                  </div>
                </div>
                <div class="col-md">
